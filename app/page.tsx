  ...
  <div className="container hero-grid grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
    ...
    <div className="order-2 md:order-1 text-center md:text-left">
      ...
      <section className="light-section containers py-20 bg-white text-black text-center px-6">
        <div className="max-w-3xl mx-auto p-10">
          ...
          <p className="text-gray-700 leading-relaxed">
            ...
            UI/UX design, and front-end development. I’ve worked on live client websites, internal company systems,
            and academic projects, often collaborating with senior developers. I use VS Code for local development
            and enjoy turning ideas into responsive, accessible, and visually clear interfaces.
        ...
        <div className="skills-grid">
          ...
          <div className="skill-card">
            ...
            <div className="skill-tags">
              {["Laravel", "PHP", "MySQL", "REST APIs", "JavaScript", "Tailwind CSS", "Bootstrap", "HTML & CSS"]
                .map((skill, i) => (
          ...
          <div className="skill-card">
            ...
            <div className="skill-tags">
              {["HeidiSQL", "Postman", "Docker", "Git", "GitHub", "VS Code", "My Sql", "Linux (basic)"]
                .map((skill, i) => (
                  <span key={i} className="skill-tag">{skill}</span>
                ))}
            </div>
      ...
      <section id="experience" className="py-20 bg-black text-white text-center px-6">
        ...
        <div className="grid md:grid-cols-4 gap-6 max-w-7xl mx-auto">
          {[
            ...
            >
              <h3 className="text-lg font-bold text-green-400 mb-2">{exp.role}</h3>
              <p className="text-sm text-blue-400 mb-1">{exp.company}</p>
      ...
      <section id="contact" className="py-20 text-center px-6">
        ...
        <h3 className="text-green-400 mb-6">0790680307 / 0745382488</h3>

        <div className="flex justify-center gap-6 text-sm">
          <a href="mailto:emotokevin@gmail.com" className="hover:text-blue-500">Email</a>
          <a href="https://github.com/emoto-cyber" target="_blank" rel="noopener noreferrer" className="hover:text-green-500">GitHub</a>
          <a href="https://www.linkedin.com/in/kevin-emoto-0b617519b/" target="_blank" rel="noopener noreferrer" className="hover:text-blue-500">LinkedIn</a>
        </div>
      </section>
